...
Язык поддерживает несколько типов данных (bool, int, double), обычные для ЯП операции вроде +-*/^<> и т.д., очень просто позволяет
добавлять в язык новые стандартные функции (которые, кстати, поддерживают перегрузку). Язык декларативный.
